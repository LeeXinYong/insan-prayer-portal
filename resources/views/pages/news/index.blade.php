<x-base-layout>
    <x-slot name="page_title_slot">{{ __("news.page_title.index") }}</x-slot>
    <!--begin::Card-->
    <div class="card card-flush">
        ...
        <div class="card-header pt-6">
            ...
            <div class="card-toolbar gap-3">
                @can("arrange", \App\Models\News::class)
        ...
        <div class="card-body pt-6">
            ...
            @include("pages.common-components._empty-state-table", [
                ...
                "message" => __("empty_states.news.content"),
                "button_label" => __("empty_states.news.action"),
                "url" => Auth::user()->cannotCreate(\App\Models\News::class) ? null : route("news.create")
            ])
        </div>
        <!--end::Card body-->
    </div>
