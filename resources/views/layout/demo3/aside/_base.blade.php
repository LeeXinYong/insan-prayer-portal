        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="symbol symbol-circle symbol-40px">
                    <img src="{{ asset(theme()->getCustomizeUrlPath() . "media/avatars/default_user.png") }}" alt="photo"/>
                </div>
                <!--end::Avatar-->

                <!--begin::User info-->
                <div class="ms-2 mw-150px">
                    <div class="text-truncate">
                        <!--begin::Name-->
                        <a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bolder lh-1">{{ \Illuminate\Support\Facades\Auth::user()->name }}</a>
                        <!--end::Name-->
                    </div>

                    <!--begin::Major-->
                    <span class="text-muted fw-bold d-block fs-7 lh-1 text-truncate">{{ \Illuminate\Support\Facades\Auth::user()->email }}</span>
                    <!--end::Major-->
                </div>
                <!--end::User info-->
            </div>
