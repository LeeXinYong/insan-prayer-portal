<x-auth-layout>
    ...
    <form method="POST" action="{{ route("password.update") }}" class="form w-100" id="reset_password_form">
        @csrf
        ...
        <div class="text-center mb-10">
            ...
            <h1 class="text-dark mb-3">
                {{ __("auth.reset_password.reset_your_password") }}
            </h1>
            <!--end::Title-->

            <!--begin::Link-->
            <div class="text-gray-400 fw-bold fs-4">
                {{ __("auth.reset_password.reset_your_password_msg") }}
            </div>
            <!--end::Link-->
        </div>
        <!--begin::Heading-->
        ...
        <div class="d-flex flex-wrap justify-content-center pb-lg-0">
            <button type="submit" id="submit_btn" class="btn btn-lg btn-primary fw-bolder me-4">
                @include("partials.general._button-indicator", ["label" => __("general.button.reset_password"), "message" => __("general.button.resetting_password")])
            </button>
        </div>
        <!--end::Actions-->
    </form>
