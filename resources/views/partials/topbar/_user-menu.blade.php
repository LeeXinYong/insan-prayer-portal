...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
    ...
    <div class="menu-item px-3">
        <div class="menu-content d-flex align-items-center px-3">
            ...
            <div class="symbol symbol-50px me-5">
                <img alt="Logo" src="{{ asset(theme()->getCustomizeUrlPath() . "media/avatars/default_user.png") }}"/>
            </div>
            <!--end::Avatar-->
            ...
            <div class="d-flex flex-column mw-150px">
                ...
                <a href="#" class="fw-bold text-muted text-hover-primary fs-7 text-truncate">{{ auth()->user()->email }}</a>
            </div>
            <!--end::Username-->
        </div>
    </div>
    ...
    <div class="menu-item px-5">
        <a href="{{ route("profile.view") }}" class="menu-link px-5">
            {{ __("layout.user_menu.my_profile") }}
        </a>
    </div>
    <!--end::Menu item-->
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-5">
        <a href="{{ route("profile.changePassword") }}" class="menu-link px-5">
            {{ __("layout.user_menu.change_password") }}
        </a>
    </div>
    <!--end::Menu item-->
